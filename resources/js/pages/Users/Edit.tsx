...
import type { BreadcrumbItem, EstadoUsuario, PageProps, Role, UserWithRoles } from '@/types';
...
export default function Edit() {
    ...
    const handleCancel = () => {
        const changed =
            ...
            data.domicilio !== (user.domicilio ?? '') ||
            data.username !== user.username ||
            data.email !== user.email ||
            data.estado !== user.estado ||
            data.rol !== (user.roles[0]?.name ?? 'usuario') ||
            data.password !== '';

        if (changed && !confirm('¿Seguro que querés salir? Los cambios sin guardar se perderán.')) {
            return;
        }
            ...
            <div className="flex flex-col gap-4 p-4">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                        Modificá los datos de la cuenta y su rol global dentro de Vendra.
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <CardContent className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <Select value={data.rol} onValueChange={(value) => setData('rol', value)} disabled={processing}>
